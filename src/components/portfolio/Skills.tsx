...
export function Skills() {
  ...
  return (
    <section
      ref={sectionRef}
      id="skills"
      className="relative overflow-hidden bg-[hsl(var(--section-4))] py-16 sm:py-20 lg:py-28"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
        ...
        >
          ...
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl font-semibold text-center mb-10 sm:mb-16">
              My Journey
            </h3>
                ...
                {experiences.map((exp, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          "w-full md:w-[46%] bg-background/95 border border-black/30 dark:border-border/30 rounded-2xl sm:rounded-[26px] p-5 sm:p-7 lg:p-10 shadow-md transition-all duration-500 hover:-translate-y-2 hover:border-primary/40 hover:shadow-[0_20px_60px_rgba(99,102,241,0.12)]",
                      ...
                      >
                        ...
                        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed mt-4 text-left sm:text-justify">
                          {exp.description}
                        </p>
